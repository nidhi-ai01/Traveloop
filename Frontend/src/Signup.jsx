              ...
              <div className="w-full space-y-3">
                {!isLogin && (
                  <div className="relative border border-gray-200 rounded-2xl px-4 py-1.5 bg-white focus-within:border-gray-400 transition shadow-sm">
                    ...
                    <input type="text" defaultValue="Robert Fox" className="w-full bg-transparent outline-none text-gray-900 text-sm font-medium pt-0.5 pb-1" />
                  </div>
                )}
                
                <div className="relative border border-gray-200 rounded-2xl px-4 py-1.5 bg-white focus-within:border-gray-400 transition shadow-sm">
                  <label className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">Email</label>
                  <input type="email" defaultValue="robert.fox@gmail.com" className="w-full bg-transparent outline-none text-gray-900 text-sm font-medium pt-0.5 pb-1" />
                </div>

                <div className="relative border border-gray-200 rounded-2xl px-4 py-1.5 bg-white focus-within:border-gray-400 transition shadow-sm flex items-center justify-between">
                  <div className="flex-1">
                    <label className="text-[10px] uppercase font-bold text-gray-400 tracking-wider">Password</label>
                    <input type={passwordVisible ? "text" : "password"} defaultValue="password123" className="w-full bg-transparent outline-none text-gray-900 text-sm font-medium pt-0.5 pb-1 tracking-[4px]" />
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1 bg-green-50 text-green-600 px-2 py-1 rounded-md text-[10px] font-bold tracking-wide">
                      Strong <Check size={12} strokeWidth={3} />
                    </div>
